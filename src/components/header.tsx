      ...
      {showMenu && (
        <div className="fixed inset-0 z-50 bg-background/95 backdrop-blur-xl flex flex-col items-center justify-center">
          ...
          <ol className="flex flex-col items-center gap-8 list-none p-0">
            ...
            <li className="mt-8">
              <a href="/Vinit%20Sharma.pdf" target="_blank" rel="noopener noreferrer" className="rounded-full bg-primary/10 px-10 py-4 text-xl font-bold text-primary transition-all hover:bg-primary/20" onClick={closeMenu}>
                Resume
              </a>
            </li>
          </ol>
